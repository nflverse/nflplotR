...
[![Codecov test coverage](https://codecov.io/gh/nflverse/nflplotR/branch/main/graph/badge.svg)](https://app.codecov.io/gh/nflverse/nflplotR?branch=main)
<!-- badges: end -->
...
The easiest way to get nflplotR is to install it from [CRAN](https://CRAN.R-project.org) with:
