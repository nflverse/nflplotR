...
The great Thomas Mock has implemented the function [`gt_plt_bar_pct`](https://jthomasmock.github.io/gtExtras/reference/gt_plt_bar_pct.html) in his {gtExtras} package. 
...
Basically, `gtExtras::gt_plt_bar_pct` is a special case of `nflplotR::gt_pct_bar`, which can be reproduced with the correct styling. See how [Tom's example](https://jthomasmock.github.io/gtExtras/reference/gt_plt_bar_pct.html#figures) is reproduced with nflplotR below. 
